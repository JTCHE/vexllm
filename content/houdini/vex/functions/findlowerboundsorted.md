...
- [find](https://vexllm.dev/docs/houdini/vex/functions/find)
- [findsorted](https://vexllm.dev/docs/houdini/vex/functions/findsorted)
- [findlowerbound](https://vexllm.dev/docs/houdini/vex/functions/findlowerbound)
- [sort](https://vexllm.dev/docs/houdini/vex/functions/sort)
...
- [find](https://vexllm.dev/docs/houdini/vex/functions/find)
- [findlowerbound](https://vexllm.dev/docs/houdini/vex/functions/findlowerbound)
- [findlowerboundsorted](https://vexllm.dev/docs/houdini/vex/functions/findlowerboundsorted)
- [findsorted](https://vexllm.dev/docs/houdini/vex/functions/findsorted)
- [insert](https://vexllm.dev/docs/houdini/vex/functions/insert)
- [isvalidindex](https://vexllm.dev/docs/houdini/vex/functions/isvalidindex)